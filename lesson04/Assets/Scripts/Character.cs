...
public class Character : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        hitSound = GetComponentInChildren<HitSoundPlayer>();
...
*/
    ...
    {
        HitSoundPlayer footSound = GetComponentInChildren<HitSoundPlayer>();
        footSound.Play(6);
    }
            ...
            switch (state)
            {
                ...
                case State.Shoot:
                    if (target.state != State.Died)
                    {
                        ...
                        {
                            HitGunFireAnimation hitGunFire = GetComponentInChildren<HitGunFireAnimation>();
                            hitGunFire.PlayEffect();
    ...
    public void DoDamgeToTarget()
    {
        ...
        HitSoundPlayer hitTargetSound = target.GetComponentInChildren<HitSoundPlayer>();
        ...
        if (health != null)
        {
            ...
            targetHealthBar.SetHealth(health.current);
