...
public class GameContoller : MonoBehaviour
{
    ...
    public PlayerWonLogic playerLogic;
    ...
    void PlayerWon() { 
        ...
        Character character = FirstAliveCharacter(playerCharacters);
        HitSoundPlayer hitSound = character.GetComponentInChildren<HitSoundPlayer>();
        hitSound.Play(10);

        playerLogic.PlayerWon();
    }
    
    void PlayerLost() { 
        Debug.Log("Player lost!");

        Character character = FirstAliveCharacter(enemyCharacters);
        HitSoundPlayer hitSound = character.GetComponentInChildren<HitSoundPlayer>();
        hitSound.Play(9);

        playerLogic.PlayerLost();
    }
